...
module ``about lists`` =
    ...
    let CreatingLists() =
        ...
        AssertEquality list.Tail ["pear"; "grape"; "peach"] // tail is everything after the first element.
    ...
    let TransformingListsWithMap() =
        ...
        AssertEquality result [for i in original do yield i * i]
    ...
    let DividingListsWithPartition() =
        ...
        AssertEquality result1 [for i in original do
                                    if isOdd i then yield i]
